...
// Text
$_['text_title']					  = 'Pay with Credit Card via CCBill';
$_['text_payment']					= 'Payment';
$_['text_total']					  = 'Total';
$_['text_success']					= 'Success: You have modified CCBill account details!';
$_['text_edit']             = 'Edit CCBill Settings';
$_['text_ccbill_standard']	= '<a target="_BLANK" href="https://www.ccbill.com/uk/mrb/pal=V4T754QB63XXL"><img src="https://www.ccbill.com/common/img/logo_CCBill_home.png" alt="CCBill Website" title="CCBill Website" style="border: 1px solid #EEEEEE;" /></a>';
